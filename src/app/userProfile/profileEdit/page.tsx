...
import { useState, useRef } from 'react'; // Import useState and useRef for file upload
import Sidebar1 from '../../../Components/Sidebar1';
import BottomNav from '../../../Components/BottomNav';

const Image1 = '/PgBee.png';
const DefaultImage2 = '/Person.png'; // Your default profile picture

// --- Mobile Layout Component ---
function MobileProfileEdit({ imagePreview, handleIconClick, fileInputRef, handleImageChange }) {
    const router = useRouter();

    const handleSaveChanges = () => {
        // Here you would add the logic to upload the new image file
...
function DesktopProfileEdit({ imagePreview, handleIconClick, fileInputRef, handleImageChange }) {
    const router = useRouter();
